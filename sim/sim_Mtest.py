...
for beta0 in [.00, .1, .2, .3, .4]:
	for case in ['quad+linear', 'quad+exp', 'quad+abs', 'quad+inverse', 'quad+log']:
	# for case in ['inverse+linear', 'inverse+exp', 'inverse+abs', 'inverse+quad', 'inverse+log']:
	# for case in ['quad']:
